...
<body>
<button class="theme-toggle" onclick="toggleTheme()" id="themeBtn"><i class="bi bi-sun-fill" id="themeIcon"></i> <span id="themeLabel">Light</span></button>
<div class="auth-card">
    ...
    <p class="text-center mt-3" style="color:var(--muted);">No account? <a href="{{ route('register') }}" style="color:var(--accent);">Register</a></p>
</div>
